                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="index.php?action=cthanghoa">Loại menu</a>
                            </div>
                        </li>
                        <!-- Thống kê -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="index.php?action=chart&act=tonkho">Tồn kho</a>
                                <a class="dropdown-item" href="index.php?action=chart&act=least">Sản phẩm bán ít nhất</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?action=dangnhap&act=log_out">Đăng xuất</a>
                        </li>
                    </ul>
                </nav>
                <!-- end test -->
